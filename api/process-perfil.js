...
export default async function handler(req, res) {
  ...
  let processPdfFiles;
  try {
    const pdfProcessor = await import('../backend/pdfPerfilProcessor.js');
    processPdfFiles = pdfProcessor.processPdfFiles;
  } catch (error) {
    console.error('Error importando pdfPerfilProcessor:', error);
  ...
  try {
    ...
    res.setHeader('Content-Disposition', 'attachment; filename=resumen_cargas.xlsx');
